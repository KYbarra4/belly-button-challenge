...
function init() {
    ...
    // Use sample_values as the values for the bar chart
            let sample_values = sampleYdata.sample_values;
    ...
    // Use otu_labels as the hovertext for the chart
            let otu_labels = sampleYdata.otu_labels;
    ...
    // Using the same data from above to plot the bubble chart for bacteria cultures per sample ID
            let trace2 = [{
                x: otu_ids,
                y: sample_values,
                labels: otu_labels,
    ...
    // Creating title for the bubble chart
            let bubbleLayout = {
                title: 'Bacteria Cultures Per Sample ID',
            }
